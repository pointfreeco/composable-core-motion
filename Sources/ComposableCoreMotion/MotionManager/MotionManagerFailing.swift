...
extension MotionManager {
  public static let failing = Self(
    ...
    startAccelerometerUpdates: { .failing("MotionManager.startAccelerometerUpdates") },
    startDeviceMotionUpdates: { _ in .failing("MotionManager.startDeviceMotionUpdates") },
    startGyroUpdates: { .failing("MotionManager.startGyroUpdates") },
    startMagnetometerUpdates: { .failing("MotionManager.startMagnetometerUpdates") },
